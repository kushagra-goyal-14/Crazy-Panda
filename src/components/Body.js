...
const Body = () => {
  ...
  async function RestrauntList() {
    const data = await fetch(
      "https://cors-anywhere.herokuapp.com/https://www.swiggy.com/dapi/restaurants/list/v5?lat=28.7239568&lng=77.1289503&sortBy=RELEVANCE&page_type=DESKTOP_WEB_LISTING"
    );
  ...
  function filterdata(restrauntlist, searchtext) {
    const data = restrauntlist.filter((e) =>
